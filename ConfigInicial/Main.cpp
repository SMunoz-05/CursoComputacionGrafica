...
#include <GL/glew.h> //Nos ayuda a gestionar las extensiones de opengl con esto aseguramos tener acceso a las características necesarias que contienen con copengl 

#include <GLFW/glfw3.h> //glfw se encarga de la creación de ventanas de la gestión de las entradas es la manera en la cual nosotros podemos interactuar con el hardware dispositivos de entrada como van a ser en las siguientes sesiones el manejo del teclado el manejo del mouse el manejo de algún otro periférico lo hacemos mediante esta librería
